...
- **Map v2 + QoL (2026-07-08):** bigger cross-shaped church, barn recentered mid-west, Hay Field VP enlarged/moved beside it, sparser irregular forests, roads Parking→Maison/Church, dirt/gravel ground patches; multi-select move orders snap to nearby cover (≤6m, unoccupied); hovering a building reveals its interior.
